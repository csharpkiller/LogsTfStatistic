...
public class ClassDeaths {

    private Map<String, ClassDeathEntry> entries = new HashMap<>();
    private boolean entries_open = true;

    @JsonAnySetter
    public void handleEntry(String steamid, ClassDeathEntry entry) {
        entries.put(steamid, entry);
    }

    public Map<String, ClassDeathEntry> getEntries() {
        return entries;
    }

    public void setEntries(Map<String, ClassDeathEntry> entries) {
        if (entries_open) {
