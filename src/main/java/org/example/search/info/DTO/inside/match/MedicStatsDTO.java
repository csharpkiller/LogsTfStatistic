...
public class MedicStatsDTO {
    ...
    /**
     * Сколько раз умер медик когда у него был убер или почти был
     */
    private final int advantages_lost;

    /**
     * Размер самого большого потерянного преимущества. Допустим умер с готовым убером 100% или с почти готовым 80%.
     */
    private final int biggest_advantage_lost;

    /**
     * Сколько раз умер союзник, на которого использовали убер, в течение 20 секунд после окончания.
     */
    private final int deaths_within_20s_after_uber;

    /**
     * Среднее кол-во времени которое ждал медик до использования убера, уже имея его.
     */
    private final int avg_time_before_using;
